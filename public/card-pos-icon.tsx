...
const CardPosIcon: React.FC<IconProps> = ({ className = "" }) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M11.1016 18.279L12.3016 17.079"
        stroke="#00a4a6"
        stroke-width="1.5"
        stroke-miterlimit="10"
        stroke-linecap="round"
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M2 21.9985H22" stroke="#00a4a6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}
