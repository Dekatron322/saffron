...
const CancelledOrders = () => {
  ...
  const [orders, setOrders] = useState<Order[]>([
    ...
    },
    {
      ...
      paymentStatus: "Paid",
      date: "2024-12-20",
      cancellationReason: "Fraud Prevention",
      cancelledBy: "Admin",
    },
    {
      sn: 4,
              ...
              <table className="w-full min-w-[800px] border-separate border-spacing-0 text-left">
                <thead>
                  <tr>
                    ...
                    <th
                      className="cursor-pointer whitespace-nowrap border-b bg-[#F4F9F8] p-4 text-sm"
                      onClick={() => toggleSort("cancellationReason")}
                    >
                      <div className="flex items-center gap-2">
                        Cancellation Reason <RxCaretSort />
                      </div>
                    </th>
                    <th
                      className="cursor-pointer whitespace-nowrap border-b bg-[#F4F9F8] p-4 text-sm"
                      onClick={() => toggleSort("cancelledBy")}
                    >
                      <div className="flex items-center gap-2">
                        Cancelled By <RxCaretSort />
                      </div>
                    </th>
                ...
                <tbody>
                  {currentOrders.map((order, index) => (
                    <tr key={index}>
                      ...
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">
                        <div className="flex items-center gap-2">{order.cancellationReason}</div>
                      </td>
                      <td className="whitespace-nowrap border-b px-4 py-2 text-sm">
                        <div className="flex items-center gap-2">{order.cancelledBy}</div>
                      </td>
