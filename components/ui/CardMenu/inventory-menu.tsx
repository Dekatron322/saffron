    ...
    <div className="mb-3 flex w-full cursor-pointer gap-3 max-sm:flex-col">
      <div className="small-card rounded-md p-2 transition duration-500 md:border">
        <div className="flex items-center gap-2   max-sm:mb-2">
          ...
          <div className="w-full">
            <span className="text-grey-400 ">Total Products </span>
      ...
      <div className="small-card rounded-md p-2 transition duration-500 md:border">
        <div className="flex items-center gap-2   max-sm:mb-2">
          <TotalIcon />
          <div className="w-full">
            <span className="text-grey-400 ">In Stock Items </span>
            <div className="flex w-full  justify-between">
              <p>45,000</p>
              <div className="flex items-center gap-1">
                <UpIcon />
      ...
      <div className="small-card rounded-md p-2 transition duration-500 md:border">
        <div className="flex items-center gap-2   max-sm:mb-2">
          <StockIcons />
          <div className="w-full">
            <span className="text-grey-400 ">Low Stock Items </span>
            <div className="flex w-full  justify-between">
              <p>17,500</p>
              <div className="flex items-center gap-1">
                <UpIcon />
      ...
      <div className="small-card rounded-md p-2 transition duration-500 md:border">
        <div className="flex items-center gap-2   max-sm:mb-2">
          <GrowthRate />
          <div className="w-full">
            <span className="text-grey-400 ">Expired Items </span>
            <div className="flex w-full  justify-between">
              <p>25</p>
              <div className="flex items-center gap-1">
                <UpIcon />
