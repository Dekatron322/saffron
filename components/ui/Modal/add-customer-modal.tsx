...
interface PaymentSidebarProps {
  isOpen: boolean
  onClose: () => void
  onCustomerAdded?: () => void // Optional callback when customer is added
}
...
const AddCustomerModal: React.FC<PaymentSidebarProps> = ({ isOpen, onClose, onCustomerAdded }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    customerPhone: "",
    customerAddress: "",
    customerPassword: "123456", // Default password as per your API
  })
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const errorMessage =
        ...
        error?.message ||
        "There was an issue adding the customer. Please try again."
